...
all_or_any_expression : (ALL 
 	|ANY 
 	|SOME)*(subquery);
comparison_expression : string_expressioncomparison_operator(string_expression
...
boolean_expression : boolean_primary 
 	|(subquery);
boolean_primary : statsimple_entity_expression : identification_variable 
 	| input_parameter;
